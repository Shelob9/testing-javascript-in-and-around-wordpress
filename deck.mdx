...
<Head>
  ...
  <meta name="twitter:description" content="Slides for Josh Pollock's talk from JavaScript For WordPress 2019 confrence, JavaScript Testing In And Around Wordress" />
  <meta name="twitter:title" content="JavaScript Testing In And Around Wordress | Josh Pollock" />
</Head>
...
- [React Testing Library](https://testing-library.com/docs/react-testing-library/intro)
  - Good for basic test, snapshots, testing events, testing hooks, etc.
...
`@wordpress/scripts` works on top of Jest, webpack, etc.
